...
export default function Spotify () {
    ...
    const song = nowPlaying?.isPlaying ? nowPlaying : recentlyPlayed;
                ...
                <div className="w-full h-full flex flex-col xl:flex-row xl:items-center">
                    ...
                    <div className="mt-4 xl:mt-0 xl:ml-8">
                        <div className="flex items-center mb-2">
                            <PiCircleFill color={nowPlaying.isPlaying ? "#1DB954" : "#c2b3c6"} />
                            <p className="text-2xl pl-2">{nowPlaying?.isPlaying ? "Currently PLaying" : "Last Played"}</p>
                        </div>
