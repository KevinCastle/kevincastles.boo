...
import { SiHtml5, SiJavascript, SiTypescript, SiReact, SiVuedotjs, SiNextdotjs, SiTailwindcss, SiBootstrap, SiSass } from 'react-icons/si'
      ...
      <Layout className='grid grid-cols-12 grid-rows-none lg:grid-rows-3 gap-4'>
        <div className='col-span-12 md:col-span-6 lg:col-span-7 xl:col-span-8 lg:row-span-1 h-full'>
          <Link href={''} target='' className='h-full order-1'>
            <Card link={true} className='h-full'>
        ...
        <Card className='col-span-12 lg:col-span-5 xl:col-span-4 lg:row-span-3 order-3 lg:order-2 !p-4 md:!p-6 lg:!p-8 !bg-gray-800/40'>
          <div className='grid grid-cols-9 lg:grid-cols-3 gap-4 md:gap-6 lg:gap-12'>
            ...
            <Tooltip message={"React"} top={true}>
            ...
            <Tooltip message={"Vue.JS"} top={true}>
            ...
            <Tooltip message={"Next.JS"} top={true}>
        ...
        <div className='col-span-12 md:col-span-6 lg:col-span-7 xl:col-span-8 lg:row-span-2 order-2 lg:order-3 h-full'>
          <Link href={''} target=''>
            <Card link={true} className='!bg-secondary-500/70 hover:!bg-secondary-500/90 h-full flex flex-col justify-center'>
              ...
              <p className='text-sm mt-2'>Have worked with a team of <span className='font-semibold'>skilled develeopers</span> on a wide range of projects where I <span className='font-semibold'>developed components or even a large part of the application.</span> Over the past few years, I have transitioned into a <span className='font-semibold'>leadership position of Frontend developers.</span></p>
            </Card>
          </Link>
        </div>
      </Layout>
